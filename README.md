...
- Copy all the files from coinor-cgl to Cgl-0.60.2 (for example)
- In Cgl-0.60.2 create a build directory (mkdir build)
- In Cgl-0.60.2/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/cgl-0.60.2 -DCMAKE_BUILD_TYPE=RELEASE ..'
- In Cgl-0.60.2/build, launch 'cmake-gui .' to fine tune the configuration
- Make the libraries: make
- Install the libraries: sudo make install

An example:
```
$ wget https://www.coin-or.org/download/source/Cgl/Cgl-0.60.2.tgz
$ tar xvfz Cgl-0.60.2.tgz
$ git clone https://github.com/ycollet/coinor-cgl.git
$ cp -r coinor-cgl/* Cgl-0.60.2/
$ cd Cgl-0.60.2
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/cgl-0.60.2 -DCMAKE_BUILD_TYPE=RELEASE ..
...
- Clone the repository
- Copy all the files from Cbc-git to Cgl-0.60.2 (for example)
- In Cgl-0.60.2 create a build directory (mkdir build)
- In Cgl-0.60.2/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/cgl-0.60.2 -DCMAKE_BUILD_TYPE=RELEASE -G "NMake Makefiles" ..'
- In Cgl-0.60.2/build, launch 'cmake-gui .' to fine tune the configuration
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/cgl-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang -DCMAKE_CXX_FLAGS="-fsanitize=memory" ..
# or
$ cmake -DCMAKE_INSTALL_PREFIX=~/cgl-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang++ -DCMAKE_C_COMPILER=/usr/bin/clang \ 
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/cgl-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/opt/intel/bin/icpc -DCMAKE_C_COMPILER=/opt/intel/bin/icc ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=d:/cgl-bin -DCMAKE_BUILD_TYPE=DEBUG -G "NMake Makefiles" ..
$ nmake
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/home/me/cgl-bin -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_TOOLCHAIN_FILE=cmake/mingw64-toolchain.cmake ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/cgl-devel -DCMAKE_BUILD_TYPE=RELEASE ..
$ make
...
$ coinbrew/coinbrew fetch --git --main-proj="Cgl"
$ cp -r ../coinor-cgl/* Cgl/
$ cd Cgl
$ mkdir build
$ cd build
